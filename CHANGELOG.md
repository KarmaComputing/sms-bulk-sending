...
- #3 fix use issue templates flash messages ([@chrisjsimpson](https://github.com/chrisjsimpson))
...
- inital commit and parsing of existing spreadsheet structure ([@chrisjsimpson](https://github.com/chrisjsimpson))
